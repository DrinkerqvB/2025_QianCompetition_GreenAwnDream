...
{ 
	...
	//printf("%d,%d,%d,%d,%f\n",IR_Data_number[1],IR_Data_number[3],IR_Data_number[5],IR_Data_number[7],error);
...
//				
//				//printf("%c,%c,%c,%c,%c,%c,%c,%c\n",new_package[6],new_package[11],new_package[16],new_package[21],new_package[26],new_package[31],new_package[36],new_package[41]);
//				
